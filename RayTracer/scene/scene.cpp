...
double Scene::ConstantAtten() { return traceUI->m_nConstantAtten; };

double Scene::LinearAtten() { return traceUI->m_nLinearAtten; };

double Scene::QuadricAtten() { return traceUI->m_nQuadricAtten; };

double Scene::AmbientLight() { return traceUI->m_nAmbientLight; };
